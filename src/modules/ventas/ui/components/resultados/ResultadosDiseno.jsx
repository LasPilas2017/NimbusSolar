// src/modules/ventas/ui/components/resultados/ResultadosDiseno.jsx
import React from "react";
import * as Recharts from "recharts";
import { fmtQ } from "../../../../../shared/utils/fmtQ";

export default function ResultadosDiseno({ datos = [] }) {
  // Si vienen datos, úsalos; si no, demo en 0
  const demo = datos.length
    ? datos
    : [
  ...
  const [modoRango, setModoRango] = React.useState(false);
    ...
    <div className="w-full h-full px-2 sm:px-4 pb-6">
      ...
      <div className="bg-[#1E2733] text-white rounded-xl shadow px-3 sm:px-5 py-3 sm:py-4 mb-4">
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          {/* === Filtros compactos === */}
          <div
            className="bg-[#E9EAEC] rounded-xl px-3 py-2 shadow-inner
          ...
          >
            ...
            <div className="flex items-center gap-2 flex-[2_1_420px] min-w-[280px] max-w-[560px]">
              ...
              <span
                className={`font-semibold text-center px-1 w-3 sm:w-4
              ...
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={demo} margin={{ top: 6, right: 6, bottom: 6, left: 6 }}>
                  ...
                  <YAxis
                    ...
                    tickMargin={4}
                  />
                  <Tooltip formatter={(val, name) => (name?.toLowerCase() === "ventas" ? fmtQ(val) : val)} />
                  {showProspectos && (
                    <Line
                      yAxisId="left"
                      type="monotone"
